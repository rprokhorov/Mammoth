...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::autocomplete_users_in_channel,
            ...
            commands::save_emoji_cache,
            commands::load_emoji_cache,
        ...
        .run(|_app, _event| {
            // Clicking the Dock icon reopens the hidden window. RunEvent::Reopen
            // is a macOS-only variant, so this must not be compiled elsewhere.
            #[cfg(target_os = "macos")]
