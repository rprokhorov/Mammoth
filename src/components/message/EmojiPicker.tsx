...
const EMOJI_CATEGORIES: Record<string, string[]> = {
  ...
  "Travel": [
    ...
    "rocket", "flying_saucer", "parachute", "luggage", "tent",
...
export const EMOJI_MAP: Record<string, string> = {
  ...
  astronaut: "🧑‍🚀", firefighter: "🧑‍🚒", office_worker: "🧑‍💼",
  judge: "🧑‍⚖️", lawyer: "🧑‍⚖️",
  ...
  beach_umbrella: "🏖️", beach_with_umbrella: "🏖️", desert: "🏜️", desert_island: "🏝️",
  national_park: "🏞️", stadium: "🏟️", classical_building: "🏛️",
  building_construction: "🏗️", houses: "🏘️",
  derelict_house: "🏚️", house: "🏠", home: "🏠", house_with_garden: "🏡",
